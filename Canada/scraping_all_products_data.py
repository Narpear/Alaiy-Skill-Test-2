...
# ---------- SETTINGS ----------
# INPUT_FILE = "amazon_canada_products.json"
INPUT_FILE = "temp_toronto.json"
...
def main():
    ...
    # Only process the entry for Toronto
    # Switch between Toronto, Vancouver
    for city_data in data:
        if city_data["location"].lower() == "toronto":
