...
# ---------- SETTINGS ----------
# INPUT_FILE = "amazon_uk_products.json"
INPUT_FILE = "temp_london.json"
...
def main():
    ...
    # Only process the entry for London
    # Switch between London, Glasgow
    for city_data in data:
        if city_data["location"].lower() == "london":
